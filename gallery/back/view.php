<html lang="en-us"><head>
                <meta charset="utf-8">
                <title>Serenity - Responsive HTML Template - Live Preview - WrapBootstrap</title>
                <meta name="description" content="Live preview for Serenity - Responsive HTML Template at WrapBootstrap">
                        ...
                        <div id="tray" class="topbar" sty1le="width: auto;">
                                <div class="fill">
                                        <div class="container">
                                                ...
                                                <h1 id="item_name"><a href="https://wrapbootstrap.com/theme/serenity-responsive-html-template-WB0MN4GG2">Serenity - Responsive HTML Template</a></h1>
                                                    <div class="remove"><a class="btn" href="http://wbpreview.com/previews/WB0MN4GG2/" title="Remove this frame">Remove this frame ≫</a></div>
                                                
                                                
                                        </div>
                                </div>
                        </div>
                            <iframe id="preview" src="http://wbpreview.com/previews/WB0MN4GG2/" frameborder="0" width="100%" height="832px"></iframe>
                </div>
                <script>
