...
<script type="text/javascript">
	$(document).ready(function() {
		$("#gallery").click(function() {
			$("#gallery_preview").load("<?php echo ($common_root);?>gallery/index.php?wpage_m=DC");
			//$("#gallery_button").hide();
			//$("#back_button").show();
		});
	});
    ...
    <!-- Gallery -->
				          ...
				          <div class="slider responsive">
									<div><img u="image" src="<?php echo ($common_root);?>img/developments/commercial_04.jpg"></div>
									<div><img u="image" src="<?php echo ($common_root);?>img/developments/commercial_05.jpg"></div>
									<div><img u="image" src="<?php echo ($common_root);?>img/developments/commercial_06.jpg"></div>
									</div>
							</div>