...
<div class="container-fluid bgcolor_brown_gradation">
    <div class="row">
    ...
    <div class="row">
        <div >
            <section class="mainContent bgcolor_brown_gradation">
            	<div class="sub_brown_gradation">
		            <h1>our story</h1>
		            <h2>About Kapstone</h2>
		            <div class="underline ">
		                <hr class="greenbar ">
		            </div>
		            <h3>Calgary’s Complete Property Development <br />& Maintenance Professionals</h3>
		            <div class="underline ">
		                <hr class="greenbar ">
		            </div>
		            ...
		            <h5>
			            ...
			            And putting your needs first in our effort <span class="emphsis_ba">to be Calgary’s first-choice, one-stop service provider 
			          for all our clients’ building and maintenance needs.</span>
			          </h5><br>
			          
			          
		            <h1>THE KAPSTONE TEAM</h1>
